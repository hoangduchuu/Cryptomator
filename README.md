...
[![Mastodon](https://img.shields.io/mastodon/follow/176112?domain=mastodon.online&style=flat)](https://mastodon.online/@ncryptor)
[![Community](https://img.shields.io/badge/help-Community-orange.svg)](https://community.ncryptor.com)
[![Documentation](https://img.shields.io/badge/help-Docs-orange.svg)](https://docs.cryptomator.org)
[![Crowdin](https://badges.crowdin.net/cryptomator/localized.svg)](https://translate.cryptomator.org/)

nCryptor offers multi-platform transparent client-side encryption of your files in the cloud.

nCryptor for Android is currently available in the following  distribution channels:

1. [Using Google Play](https://play.google.com/store/apps/details?id=org.cryptomator)
2. [Using nCryptor's Website](https://ncryptor.com/android/)
3. [Using nCryptor's F-Droid Repository](https://ncryptor.com/android/)
...
### Reproducible Build nCryptor Lite
...
4. Build nCryptor using `docker run --rm -u $(id -u):$(id -g) -v $(pwd):/project -w /project cryptomator-android ./gradlew clean assembleLiteRelease` in the root of this folder
...
You can verify the fingerprint of the signing key used e.g. with `apksigner verify --print-certs nCryptor.apk`, which should report
...
## Contributing to nCryptor for Android
...
Help us keep nCryptor open and inclusive. Please read and follow our [Code of Conduct](.github/CODE_OF_CONDUCT.md).

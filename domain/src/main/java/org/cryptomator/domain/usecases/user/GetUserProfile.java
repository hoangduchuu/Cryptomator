...
class GetUserProfile {
	...
	public GetUserProfile(UserRepository repository,  @Parameter String accessToken, @Parameter DeviceArgs deviceArgs) {
	...
	public UserProfile execute() throws BackendException {
		return repository.getUserProfile(accessToken,deviceArgs);
	}
}

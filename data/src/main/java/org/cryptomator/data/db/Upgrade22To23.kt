...
@Singleton
internal class Upgrade22To23 @Inject constructor() : DatabaseUpgrade(22, 23) {

    override fun internalApplyTo(db: Database, origin: Int) {
        db.beginTransaction()
        try {
            addPolicyEtagToVaultSchema(db)
    ...
    private fun addPolicyEtagToVaultSchema(db: Database) {
        // Step 1: Rename old table
        Sql.alterTable("VAULT_ENTITY").renameTo("VAULT_ENTITY_OLD").executeOn(db)

        // Step 2: Create new table with POLICY_ETAG column
        Sql.createTable("VAULT_ENTITY") //
            ...
            .optionalInt("SIZE") //
            .optionalText("POLICY_ID") //
            .optionalInt("DRIVE_QUOTA") //
            .optionalText("POLICY_ETAG") //
        ...
        db.execSQL("""
            INSERT INTO VAULT_ENTITY (
                ...
                ETAG, STATUS, FULL_LOCAL_PATH, SIZE, POLICY_ID, DRIVE_QUOTA, POLICY_ETAG
            )
            SELECT 
                ...
                VAULT_ENTITY_OLD.SIZE, VAULT_ENTITY_OLD.POLICY_ID, 
                VAULT_ENTITY_OLD.DRIVE_QUOTA, NULL

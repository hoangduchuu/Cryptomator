...
@Singleton
internal class Upgrade18To19 @Inject constructor() : DatabaseUpgrade(18, 19) {

    override fun internalApplyTo(db: Database, origin: Int) {
        db.beginTransaction()
        try {
            addFullLocalPathToVaultSchema(db)
    ...
    private fun addFullLocalPathToVaultSchema(db: Database) {
        // Step 1: Rename old table
        Sql.alterTable("VAULT_ENTITY").renameTo("VAULT_ENTITY_OLD").executeOn(db)

        // Step 2: Create new table with FULL_LOCAL_PATH column
        ...
        Sql.insertInto("VAULT_ENTITY") //
            .select("_id", "FOLDER_CLOUD_ID", "FOLDER_PATH", "FOLDER_NAME", "FORMAT", "CLOUD_ENTITY.TYPE", "PASSWORD", "PASSWORD_CRYPTO_MODE", "POSITION", "SHORTENING_THRESHOLD", "DEVICE_ID", "CREATED_BY", "DESCRIPTION", "ETAG", "STATUS") //
            .columns("_id", "FOLDER_CLOUD_ID", "FOLDER_PATH", "FOLDER_NAME", "FORMAT", "CLOUD_TYPE", "PASSWORD", "PASSWORD_CRYPTO_MODE", "POSITION", "SHORTENING_THRESHOLD", "DEVICE_ID", "CREATED_BY", "DESCRIPTION", "ETAG", "STATUS") //

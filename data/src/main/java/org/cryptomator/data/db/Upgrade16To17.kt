...
@Singleton
internal class Upgrade16To17 @Inject constructor() : DatabaseUpgrade(16, 17) {
	...
	private fun addEtagToVaultSchema(db: Database) {
		...
		Sql.insertInto("VAULT_ENTITY") //
			.select("_id", "FOLDER_CLOUD_ID", "FOLDER_PATH", "FOLDER_NAME", "FORMAT", "CLOUD_ENTITY.TYPE", "PASSWORD", "PASSWORD_CRYPTO_MODE", "POSITION", "SHORTENING_THRESHOLD", "DEVICE_ID", "CREATED_BY", "DESCRIPTION") //
			.columns("_id", "FOLDER_CLOUD_ID", "FOLDER_PATH", "FOLDER_NAME", "FORMAT", "CLOUD_TYPE", "PASSWORD", "PASSWORD_CRYPTO_MODE", "POSITION", "SHORTENING_THRESHOLD", "DEVICE_ID", "CREATED_BY", "DESCRIPTION") //

...
internal class Upgrade14To15 @Inject constructor() : DatabaseUpgrade(14, 15) {
	...
	private fun addCreatedByToVaultSchema(db: Database) {
		// Step 1: Rename old table
		Sql.alterTable("VAULT_ENTITY").renameTo("VAULT_ENTITY_OLD").executeOn(db)

		// Step 2: Create new table with CREATED_BY column
		...
		Sql.insertInto("VAULT_ENTITY") //
			.select("_id", "FOLDER_CLOUD_ID", "FOLDER_PATH", "FOLDER_NAME", "FORMAT", "CLOUD_ENTITY.TYPE", "PASSWORD", "PASSWORD_CRYPTO_MODE", "POSITION", "SHORTENING_THRESHOLD", "DEVICE_ID") //
			.columns("_id", "FOLDER_CLOUD_ID", "FOLDER_PATH", "FOLDER_NAME", "FORMAT", "CLOUD_TYPE", "PASSWORD", "PASSWORD_CRYPTO_MODE", "POSITION", "SHORTENING_THRESHOLD", "DEVICE_ID") //

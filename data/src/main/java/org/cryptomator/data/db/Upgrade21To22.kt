...
@Singleton
internal class Upgrade21To22 @Inject constructor() : DatabaseUpgrade(21, 22) {

    override fun internalApplyTo(db: Database, origin: Int) {
        db.beginTransaction()
        try {
            addDriveQuotaToVaultSchema(db)
    ...
    private fun addDriveQuotaToVaultSchema(db: Database) {
        // Step 1: Rename old table
        Sql.alterTable("VAULT_ENTITY").renameTo("VAULT_ENTITY_OLD").executeOn(db)

        // Step 2: Create new table with DRIVE_QUOTA column
        ...
        db.execSQL("""
            INSERT INTO VAULT_ENTITY (
                ...
                ETAG, STATUS, FULL_LOCAL_PATH, SIZE, POLICY_ID, DRIVE_QUOTA
            )
            SELECT 
                ...
                VAULT_ENTITY_OLD.SIZE, VAULT_ENTITY_OLD.POLICY_ID, NULL
